    ...
    <div className="h-screen flex bg-gray-100 text-gray-900">
      ...
      <main className="flex-1 overflow-y-auto">
        <header className="bg-white sticky top-0 z-10 flex justify-between items-center p-4 shadow-sm">
          <i
          className="bi bi-list cursor-pointer text-3xl lg:hidden" 
        ...
        <section className="p-6 space-y-4">
          ...
          {activePage === "Denah" && <Map /> }
          {activePage === "Kelola Workspace" && workspaceId && (
            <Anggota 
                ...
                <ul className="space-y-2">
                  {workspaces.map((ws) => (
                    <li
                      ...
                      setActivePage("Dasbor"); // pindah ke dashboard biar jelas
